...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('committee_map', models.FileField(default=None, null=True, upload_to='')),
                ('committee', models.ManyToManyField(blank=True, null=True, related_name='technical_committee_members', to='core.StakeHolder')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('committee_map', models.FileField(default=None, null=True, upload_to='')),
                ('committee', models.ManyToManyField(blank=True, null=True, related_name='national_advisories', to='core.StakeHolder')),
                ('conference', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.conference')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('committee_map', models.FileField(default=None, null=True, upload_to='')),
                ('committee', models.ManyToManyField(blank=True, null=True, related_name='international_adviseries', to='core.StakeHolder')),
                ('conference', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.conference')),
            ],
        ),
        migrations.CreateModel(
