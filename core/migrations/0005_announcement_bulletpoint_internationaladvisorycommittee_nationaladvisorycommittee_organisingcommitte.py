# Generated by Django 3.2.7 on 2022-04-27 19:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('committee', models.ManyToManyField(related_name='technical_committee_members', to='core.StakeHolder')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('committee', models.ManyToManyField(related_name='national_advisories', to='core.StakeHolder')),
                ('conference', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.conference')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('committee', models.ManyToManyField(related_name='international_adviseries', to='core.StakeHolder')),
                ('conference', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.conference')),
            ],
        ),
        migrations.CreateModel(
